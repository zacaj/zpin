...
import { matrix, Switch, onSwitchClose, onClose, onAnyPfSwitchExcept, onAnySwitchClose, Lane, Drain, Bumper, DropTarget, Standup, Hole } from './switch-matrix';
...
export class Machine extends Tree<MachineOutputs> {
    ...
    sMiniLeft = new Switch(1, 7, 'mini left', DropTarget);
    sMiniCenter = new Switch(1, 6, 'mini center', DropTarget);
    sMiniRight = new Switch(1, 5, 'mini right', DropTarget);
    sCenterLeft = new Switch(4, 3, 'center left', DropTarget);
    sCenterCenter = new Switch(4, 2, 'center center', DropTarget);
    sCenterRight = new Switch(4, 1, 'center right', DropTarget);
    sLeft1 = new Switch(3, 1, 'left 1', DropTarget);
    sLeft2 = new Switch(3, 2, 'left 2', DropTarget);
    sLeft3 = new Switch(3, 3, 'left 3', DropTarget);
    sLeft4 = new Switch(3, 5, 'left 4', DropTarget);
    sRight1 = new Switch(2, 5, 'right 1', DropTarget);
    sRight2 = new Switch(2, 4, 'right 2', DropTarget);
    sRight3 = new Switch(2, 3, 'right 3', DropTarget);
    sRight4 = new Switch(2, 2, 'right 4', DropTarget);
    sRight5 = new Switch(2, 1, 'right 5', DropTarget);
    ...
    sUpper3Left = new Switch(5, 2, 'upper 3 left', DropTarget);
    sUpper3Center = new Switch(5, 1, 'upper 3 center', DropTarget);
    sUpper3Right = new Switch(5, 0, 'upper 3 right', DropTarget);
    sUpper2Left = new Switch(6, 4, 'upper 2 left', DropTarget);
    sUpper2Right = new Switch(6, 3, 'upper 2 right', DropTarget);
