...
export const gfxLights: { [name in keyof LightOutputs]: {
    ...
    lRampShowCards:  { x: 4.5562499999999995, y: 26.94375, d: 5/8 } ,  
    lRampStartMb:  { x: 4.8374999999999995, y: 26.15625, d: 3/4 } ,  
    ...
    lPower4: { x: 11.30625, y: 10.631250000000001, d: 0 },
    ...
    lMagnet4: { x: 3.8812499999999996, y: 20.08125, d: 0 },
